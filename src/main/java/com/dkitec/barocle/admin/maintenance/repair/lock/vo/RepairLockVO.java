package com.dkitec.barocle.admin.maintenance.repair.lock.vo;
...
@Alias("repairLockVo")
public class RepairLockVO extends CommonVo implements Serializable {
    ...
    private List<RepairLockVO> armList;
    ...
    private String lockReport;			//특이사항 추가_20161121_cms
	...
	public String getLockReport() {
		return lockReport;
	}
	public void setLockReport(String lockReport) {
		this.lockReport = lockReport;
	}
	...
	public List<RepairLockVO> getArmList() {
		return armList;
	}
	public void setArmList(List<RepairLockVO> armList) {
