...
@Alias("RelocationWorkOrderVO")
public class RelocationWorkOrderVO extends CommonVo implements Serializable {
	...
	private String moveCnt1;
	
	// 20210713 재배치 대여소 목록용 end
	
	public String getMoveCnt1() {
		return moveCnt1;
	}
	public void setMoveCnt1(String moveCnt1) {
		this.moveCnt1 = moveCnt1;
	}
