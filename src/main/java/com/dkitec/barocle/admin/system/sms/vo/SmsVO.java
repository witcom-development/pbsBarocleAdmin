...
public class SmsVO extends PagingVO implements java.io.Serializable {
	...
	public String toString() {
		return "SmsVO [smsSeq=" + smsSeq + ", sendClsName=" + sendClsName
	...
	@GroupSequence({GetMode.class,SmsInsert.class})
	public static interface SmsInsertVal{}
	
	@GroupSequence({GetMode.class,SmsUpdate.class})
	public static interface SmsUpdateVal{}
	
	@GroupSequence({GetMode.class,SmsDelete.class})
	public static interface SmsDeleteVal{}
