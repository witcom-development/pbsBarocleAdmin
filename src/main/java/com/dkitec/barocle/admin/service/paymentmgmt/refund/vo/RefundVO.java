package com.dkitec.barocle.admin.service.paymentmgmt.refund.vo;
...
@Alias("refundVO")
public class RefundVO extends PagingVO implements Serializable {
	...
	public void setMileageAmt(String mileageAmt) {
