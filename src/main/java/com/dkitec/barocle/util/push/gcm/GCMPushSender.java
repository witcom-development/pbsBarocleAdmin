 ...
 */ 
package com.dkitec.barocle.util.push.gcm;
...
public class GCMPushSender implements Send{
	...
	private static String AUTH_TOKEN = "AIzaSyDadCNif0CmKoaLR0aXirdfWq08HKGxU_g"; //아파트
	...
	/**
	 * @location   : com.dkitec.barocle.util.push.gcm.Sender.send
