							...
							<fieldset>
								<table class="tb_type02 mt20">
									...
									<tbody>
										...
										<tr>
											<th><em>*</em> 대표자</th>
											<td><span class="input-text08"><form:input id="chargerName" path="chargerName" type="text" readonly="true" /></span> <a href="/common/pop/showRepBikMAllAdminFindPop.do" class="winNewPop btnType02 thid"  title="사람찾기" data-width="440" data-height="455" data-pmt="&usrGrpCd=004">사람찾기</a></td>
										</tr>
										<tr>
											<th>비고</th>
										...
										<tr>
											...
											<td>
												<span>
													<span class="input-rd01"><input type="radio" id="a2" name="useYn" value="Y" checked/><label for="a2">사용</label></span>
													<span class="input-rd01"><input type="radio" id="a2" name="useYn" value="N"/><label for="a2">정지</label></span>
												</span>
											</td>
										</tr>
										<tr>
								...
								<div class="btnArea">
									<span class="left"><button class="btnType01 bc_gray" onclick="location.href='/getManageBikeMallList.do?currentPageNo=<c:out value="${centerView.currentPageNo}"/><c:out value="${parameterInfo}" escapeXml="false"/>';">목록</button></span>
				...
				$.ajax({
					...
					success		: function( data ) {
						if(data.resultMessage == 'Success'){
          	        		alert('저장이 완료되었습니다.');
          	      			location.href("/editBikeMall.do?mode=edit&centerID="+data.centerId);
          	        	}else{
          	        		alert('저장이 실패하였습니다.');
          	        	}
					},
