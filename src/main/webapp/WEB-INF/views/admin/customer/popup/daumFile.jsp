...
//<![CDATA[
	...
	$(function(){
		$("#saveBtn").click(function(){ 
			$("#frm").attr({action:actionLocation,mehtod:'post',encType:'multipart/form-data'}).submit(); });
	    $("#frm").ajaxForm({
	...
	<div class="wrapper">
	    ...
	    <div class="body">
	        <dl class="alert">
	            <dt>파일 첨부  확인 </dt>
	            <dd>
	            <form id="frm" action="/daumeditorFileUploadPer.do" method="post" encType="multipart/form-data">
