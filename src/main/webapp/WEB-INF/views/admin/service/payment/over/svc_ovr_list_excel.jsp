...
<%
	response.setHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("초과금액.xls", "UTF8"));
...
<body>
    ...
    <div style="margin-top:10px;">
        <table class="tb_condition">
            <tbody>
                <tr>
                    <td class="condition" ><label class="laType02">대여일</label></td>
    ...
    <table class="tb_type01" style="width : 1200px;">
        ...
        <c:forEach var="result" items="${overPaymentList}" varStatus="status">
            <tr>
				...
				<td class="txRight"><fmt:formatNumber type="number" value="${result.useMi}"/></td>
				<td class="txRight"><fmt:formatNumber type="number" value="${result.overMi}"/></td>
