...
<%
	response.setHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("쿠폰내역.xls", "UTF8"));
...
<body>
    ...
    <div style="margin-top:10px;">
        <table class="tb_condition">
            <tbody>
                <tr>
                    <td class="condition" ><label class="laType02">업체명</label></td>
                    <td >${searchCondition.searchValue}</td>
                    <td class="condition" ><label class="laType02">쿠폰번호</label></td>
                    <td >${searchCondition.couponNo}</td>
                ...
                <tr>
                    ...
                    <td >${searchCondition.searchStartDate} ~ ${searchCondition.searchEndDate}</td>
                    <td class="condition" ><label class="laType02">사용가능여부</label></td>
                    <td >${searchCondition.couponDelYnName}</td>
                    <td class="condition" ><label class="laType02">사용여부</label></td>
                    <td >${searchCondition.couponUseYnName}</td>
                </tr>
            </tbody>
        </table>
    </div>
