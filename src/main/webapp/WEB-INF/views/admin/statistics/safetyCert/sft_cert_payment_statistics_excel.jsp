...
<% 
    response.setHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("인증제 합격자 연월 통계.xls", "UTF8"));
...
<body>
   <div style="height:200px; width:1200px;text-align:center; margin-top:10px;">
    ...
    <div>
        <table class="tb_condition">
            <tbody>
                ...
                <tr>
                    <td style="width:200px;" class="condition" ><label class="laType02">년월체크</label></td>
                    <td style="width:400px;">${searchCondition.searchValue}</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div style="width:1200px;text-align:right;margin:10px;">
          <label class="laType02"><b>결제건수 : 총 ${totalDetailCount } 건,
