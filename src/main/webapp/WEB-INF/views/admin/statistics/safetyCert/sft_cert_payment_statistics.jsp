...
<body>
	<div class="allwrap">
		...
		<div id="body">
			<div class="cont">
				...
				<div class="content">
					<div class="subject">
						<p class="pageTitle">인증제 합격자 연월 통계</p>
						<span>통계 &gt;  <em>인증제 합격자 연월 통계</em></span>
					</div>
					<div class="page">
						<!-- 모바일 검색조건 S-->
						<div class="shBox_m">
								...
								<fieldset>
									...
									<div class="shBoxSection">
										...
										<div class="section radbox" >
											...
											<span>
												<span class="input-rd01"><input data-chn="daymth1" type="radio" id="year" name="dType" value="YEAR"><label for="year"> 년도별</label></span>
												<span class="input-rd01"><input data-chn="daymth2" type="radio" id="month" name="dType" value="MONTH"><label for="month"> 월별</label></span>
											</span>
										</div>
    ...
    <script type="text/javascript">
   	$(function() {
		...
		var searchValue = '${searchCondition.searchValue == null ? "YEAR" : searchCondition.searchValue}';
   		...
   		$('[name="dType"]').on("click", function(){
   			if($(this).attr("id") == 'year'){
   				$('[name="searchValue"]').val('YEAR');
   			}else if($(this).attr("id") == 'month'){
   				$('[name="searchValue"]').val('MONTH');
   			}
   		});
    ...
    certStatistics.exeStatisticsFnc = function(e) {
        ...
        $("#searchFrm").attr({method : 'post', action : '../safetycert/getSafetyCertPaymentStatistics.do'}).submit();
    ...
    certStatistics.exeStatisticsExcelFnc = function(e) {
        ...
        $("#searchFrm").attr({method : 'post', action : '../safetycert/getSafetyCertPaymentStatisticsExcel.do'}).submit();
    };
    
   	certStatistics.pageSelect = function(pageNo) {
    	$("[name='currentPageNo']").val(pageNo);
    	$("#searchFrm").attr({action :'../safetycert/getSafetyCertPaymentStatistics.do', method : 'post'}).submit();
    };
    </script>
</body>
</html>