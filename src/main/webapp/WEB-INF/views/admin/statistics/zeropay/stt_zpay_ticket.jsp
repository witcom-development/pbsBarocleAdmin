	...
	<div class="allwrap">
		...
		<div id="body">
			<div class="cont">
				...
				<div class="content">
					<div class="subject">
						<p class="pageTitle">이용권별 현황</p>
						<span>통계 &gt; 제로페이 &gt; <em>이용권별 현황</em></span>
					</div>
					<form id="searchFrm">
								...
								<table class="tb_type03 tb_right" style="min-width:1500px">
									...
									<thead>
										<tr>
											...
											<th colspan="2">1일권</th>
											<th colspan="2">7일권</th>
											<th colspan="2">30일권</th>
											<th colspan="2">180일권</th>
											<th colspan="2">365일권</th>
										</tr>	
									...
									<tbody>	
										<c:forEach var="result" items="${dataList}" varStatus="status">
			                                <tr>
			                                	...
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticket_1day}" pattern="#,###"/>&nbsp;&nbsp;</td> 
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticketPmt_1day}" pattern="#,###"/>&nbsp;&nbsp;</td> 
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticket_7day}" pattern="#,###"/>&nbsp;&nbsp;</td> 
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticketPmt_7day}" pattern="#,###"/>&nbsp;&nbsp;</td> 
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticket_30day}" pattern="#,###"/>&nbsp;&nbsp;</td> 
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticketPmt_30day}" pattern="#,###"/>&nbsp;&nbsp;</td> 
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticket_180day}" pattern="#,###"/>&nbsp;&nbsp;</td> 
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticketPmt_180day}" pattern="#,###"/>&nbsp;&nbsp;</td> 
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticket_365day}" pattern="#,###"/>&nbsp;&nbsp;</td> 
			                                	<td style="text-align: right;"><fmt:formatNumber value="${result.ticketPmt_365day}" pattern="#,###"/>&nbsp;&nbsp;</td>
			                                </tr>
			                            </c:forEach>    
	   	...
	   	//next page
			$("#nextPage").click(function(){
				if($("#searchStartDate").val()  &&  $("#searchEndDate").val())
					...
					fn_loading();
					$("#searchFrm").attr({method : 'post', action : '/zeropay/ticketStatistics.do'}).submit();
			});
			...
			$('#excelBtn').on("click", function(){
	    		...
	    		$('#searchFrm').attr({method : 'post', action : '/zeropay/ticketStatisticsExcel.do'}).submit();
	   		}); 
	   	});
    </script>
</body>
