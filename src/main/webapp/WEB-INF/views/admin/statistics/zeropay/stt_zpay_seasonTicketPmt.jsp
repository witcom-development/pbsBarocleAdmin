	...
	<div class="allwrap">
		...
		<div id="body">
			<div class="cont">
				...
				<div class="content">
					<div class="subject">
						<p class="pageTitle">정기권 결제 현황</p>
						<span>통계 &gt; 제로페이 &gt; <em>정기권 결제 현황</em></span>
					</div>
					<form id="searchFrm">
					...
					<div class="page">
						...
						<!--검색조건 S-->
							...
							<div style="margin-top: 25px;">
								...
								<table class="tb_type03 tb_right" style="min-width:1800px">
									<colgroup>
    	...
    	$(function() {
	        ...
	        var chkTicket = '${searchCondition.chkTicket}';
	   		if(chkTicket == 'Y'){
	   			...
	   			$(".pageTitle").text("정기권 결제 현황(제로페이 제외)");
	   		} else{
	   			$(".pageTitle").text("정기권 결제 현황");
	   		}
	   	...
	   	//next page
			$("#nextPage").click(function(){
				if($("#searchStartDate").val()  &&  $("#searchEndDate").val())
					...
					fn_loading(); 
					$("#searchFrm").attr({method : 'post', action : '/zeropay/seasonTicketStatistics.do'}).submit();
			});
			...
			$('#excelBtn').on("click", function(){
	    		...
	    		$('#searchFrm').attr({method : 'post', action : '/zeropay/seasonTicketStatisticsExcel.do'}).submit();
	   		}); 
