...
<%
    response.setHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("그룹간이동통계.xls", "UTF8"));
    ...
    <div>
        <table class="tb_condition">
            <tbody>
                ...
                <tr>
                    <td style="width:200px;" class="condition" ><label class="laType02">대여 아파트</label></td>
                    <td style="width:400px;">
                    <c:if test='${searchCondition.rentStationGrp != ""}'>
                    ${dataList[0].rentStationGrpName}
                    </c:if>
                    </td>
                    <td style="width:200px;" class="condition" ><label class="laType02">반납 아파트</label></td>
                    <td style="width:400px;">
                    <c:if test='${searchCondition.returnStationGrp != ""}'>
                    ${dataList[0].returnStationGrpName}
                    </c:if>
                    </td>
                </tr>
            </tbody>
