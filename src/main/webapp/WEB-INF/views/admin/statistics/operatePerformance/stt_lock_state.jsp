	...
	<div class="allwrap">
		...
		<div id="body">
			<div class="cont">
				...
				<div class="content">
					<div class="subject">
						<p class="pageTitle">대여소(거치대) 현황</p>
						<span>통계 &gt; <em>대여소(거치대) 현황</em></span>
					</div>
					<div class="page">
					<!-- 모바일 검색조건 S-->
						<div class="shBox_m">
				...
				<%-- <div class="content">
					<div class="subject">
						<p class="pageTitle">그룹간 이동현황</p>
						<span>통계 &gt; <em>그룹간 이동현황</em></span>
					</div>
					<div class="page">
						<!-- 모바일 검색조건 S-->
						<div class="shBox_m">
							...
							<div class="shBox">
								...
								<fieldset>
									...
									<div class="shBoxSection">
										...
										<div class="section">
											<label for="rentStationGrp" class="laType02">대여 아파트</label>
											<select class="select-category02" name="rentStationGrp" id="rentStationGrpSlt">
                                                <option value="">선택</option>
                                            </select>
										</div>
										<div class="section pright">
											<label for="returnStationGrp" class="laType02">반납 아파트</label>
											<select class="select-category02" name="returnStationGrp" id="returnStationGrpSlt">
                                                <option value="">선택</option>
                                            </select>
											<button type="button" id="searchBtn" class="btn-srh03 btncase1"><img src="/images/searchIcon.gif" alt="검색" /></button>
										</div>
