...
<body>
	<div class="allwrap">
		...
		<div id="body">
			<div class="cont">
				...
				<div class="content">
					<div class="subject">
						<p class="pageTitle">수리현황통계</p>
						<span>통계 &gt; 유지보수 통계 &gt; <em>수리현황통계</em></span>
					</div>
					<div class="page">
						<!-- 모바일 검색조건 S-->
						<div class="shBox_m">
									...
									<div class="shBoxSection">
										<div class="section radbox">
											...
											<span>
												...
												<span class="input-rd01"><input data-chn="daymth2" type="radio" id="year" name="dType" value="Y"><label for="year"> 연</label></span>
											</span>
										</div>
   	...
   	$(function() {
		...
		var dateType = '${searchCondition.dateType == null ? "D" : searchCondition.dateType}';
   		...
   		$('#searchBtn').on("click", function(){
    		...
    		$('#searchFrm').attr({method : 'post', action : '/maintain/repairStatistics.do'}).submit();
   		...
   		$('#excelBtn').on("click", function(){
    		...
    		$('#searchFrm').attr({method : 'post', action : '/maintain/repairStatisticsExcel.do'}).submit();
   		});
   		
   		var totalPageCount = '${paginationInfo.totalPageCount}' == '' ? 1 : Number('${paginationInfo.totalPageCount}');
   		$('#prevPage').on("click",function(){
			var currentPageNo = Number($('[name="currentPageNo"]').val());
			repairStatistics.pageSelect(currentPageNo-1);
		});
		...
		$('#movePage').on("click",function(){
			...
			if(!regExp.test(currentPageNo) ||(totalPageCount < currentPageNo)){
				...
				repairStatistics.pageSelect(currentPageNo);
			}
		});
   	});
	...
	repairStatistics.pageSelect = function(pageNo) {
    	$("[name='currentPageNo']").val(pageNo);
    	$("#searchFrm").attr({action :'/maintain/repairStatistics.do', method : 'post'}).submit();
    };
    </script>
</body>
</html>