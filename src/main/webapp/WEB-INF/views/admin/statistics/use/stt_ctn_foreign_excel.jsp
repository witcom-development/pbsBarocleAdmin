...
<%
    response.setHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("외국인관광객이용통계.xls", "UTF8"));
    ...
    <table class="tb_type01" style="width : 1200px;">
		...
		<c:forEach var="result" items="${dataList}" varStatus="status">
			<tr>
				...
				<td colspan="2">${result.stationName}</td>
