...
<%
    response.setHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("자전거점검관리리스트.xls", "UTF8"));
    ...
    <table class="tb_type01" style="width : 1200px;">
        <thead>
            <tr>
                ...
                <th>신고자</th>
                <th>신고일시</th>
				<c:if test="${searchCondition.chkType == 'H'}">
					<th>점검자</th>		
					<th>점검일시</th>
				</c:if>
            </tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>${info.stationName }${bike.stationName }</td>
