...
<!-- solbit test-테스트 페이지  S   -->
                        	...
                        	<fieldset>
								...
								<div class="shBoxSection">
									...
									<div class="section pright">
										<label for="aa2" class="laType02">직원</label>
		                        	...
		                        	<table class="tb_type02 my-3">
		                        		...
		                        		<thead>
		                        			<tr>
                        						...
                        						<th class="top text-center">근무 외 시간</th>
		                        		...
		                        		<tbody id="tbodyTarget">
			                        		...
			                        		<c:forEach items="${workList}" var="list" varStatus="vst">
			                        			...
			                        			<tr>
			                        				...
			                        				<td class="text-center">${fn:replace(list.dtlName, newLineChar, "<br/>")} </td>
    ...
    $(function(){
		...
		$("#searchBtn").on("click",function(e){
			...
			$("#searchFrm").attr({method : 'post', action :'/distributionDiary/getDistRoundWork.do'}).submit();
