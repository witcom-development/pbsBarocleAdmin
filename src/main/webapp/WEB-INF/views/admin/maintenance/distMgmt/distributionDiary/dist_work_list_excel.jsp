...
<%
    response.setHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("분배직원근태정보.xls", "UTF8"));
...
<body>
    <div class="shBox">
    	<table class="tb_condition">
    		<thead class="logo">
    			<tr><th colspan="5">분배원 근태 조회 결과</th></tr>
			</thead>
			<tr>
				<td>
					<label>기간</label>
