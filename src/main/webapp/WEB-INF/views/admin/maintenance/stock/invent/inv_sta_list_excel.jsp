...
<%
    response.setHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("재고내역리스트.xls", "UTF8"));
        ...
        <table class="tb_condition">
           <tbody>
               <tr>
                   ...
                   <td style="width:400px;">${searchCondition.partName}</td>
                   <td style="width:200px;" class="condition" ><label class="laType02">센터 명</label></td>
                   <td style="width:400px;">${searchCondition.centerName}</td>
               </tr>
           </tbody>
        </table>
    </div>
