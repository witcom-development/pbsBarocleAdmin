...
<%
    response.setHeader("Content-Disposition", "attachment; filename="+java.net.URLEncoder.encode("장애거치대목록.xls", "UTF8"));
...
<body>
   <div style="height:200px; width:1200px;text-align:center; margin-top:10px;">
    ...
    <table class="tb_type01" style="width : 1200px;">
        ...
        <tbody>
            <c:forEach var="result" items="${InspectLockList}" varStatus="loop">
                <tr>
            ...
            <c:if test="${fn:length(InspectLockList) == 0 }">
                <tr><td colspan="5">
