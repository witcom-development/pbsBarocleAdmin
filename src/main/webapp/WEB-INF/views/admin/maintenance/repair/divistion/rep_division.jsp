							...
							<tbody>	
								<c:forEach var="result" items="${RepairDivisionList}" varStatus="status">
	                                <tr>
	                                    ...
	                                    <td><a href="/divisionEditUdt.do?comCd=<c:out value='${result.comCd}'/>&btn_chk=<c:out value='${btnChk}'/>&currentPageNo=<c:out value='${paginationInfo.currentPageNo}'/> "> ${result.mlangComCdName}</a></td>  
