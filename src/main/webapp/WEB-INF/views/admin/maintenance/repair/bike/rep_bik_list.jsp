...
<body>
    ...
    repairBikeList.exeListFnc = function(e) {
        ...
        $("#searchFrm").attr({method : 'post', action : '/repairBikeList.do'}).submit();
    };
    
    repairBikeList.pageSelect = function(pageNo) {
    	$("[name='currentPageNo']").val(pageNo);
    	$("[name='viewFlg']").val('list');
    	$("#searchFrm").attr({action :'/repairBikeList.do', method : 'post'}).submit();
    };
    ...
    repairBikeList.moveEditForm = function (e) {
    	...
    	$("#searchFrm").attr({method : 'post', action : '/moveRepairBikeEditForm.do'}).submit();
    };
    </script>
</body>
</html>