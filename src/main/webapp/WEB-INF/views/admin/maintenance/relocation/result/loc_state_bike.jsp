...
<body>
				...
				<div class="content">
					...
					<div class="page">
									...
									<div class="shBoxSection">
										...
										<div class="section">
											...
											<select class="select-category05" name="viewType">
												...
												<option value="relocate">설치</option>
											</select>
										</div>
										<div class="section">
											<label for="bikeNo" class="laType02">자전거 번호</label>
											<span class="input-text08"><input type="text" id="bikeNo" name="bikeNo" /></span>
						...
						<div class="widscr mt5">
							<table class="tb_type01" style="min-width:1200px">
								<colgroup>
									<col style="width:8%"/>
									<col style="width:11%"/>
									<col style="width:8%"/>
    ...
    relocationStateList.exeListFnc = function(e) {
        ...
        $("#searchFrm").attr({method : 'post', action : '/relocationStateBike.do'}).submit();
    };
    ...
    relocationStateList.exeExcelFnc = function(e) {
        ...
        if( DateUtil.diffDays( $( "[name='searchBgnDe']").val(),  $( "[name='searchEndDe']").val() , "-" ) > 2 ) {
        	alert("엑셀 출력은 최대 2일만 가능합니다.")
	        return;
        }
        ...
        $("#searchFrm").attr({method : 'post', action : '/relocationStateBikeExcel.do'}).submit();
    };
    
    relocationStateList.pageSelect = function(pageNo) {
    	
    	$("[name='currentPageNo']").val(pageNo);
    	$("#searchFrm").attr({action :'/relocationStateBike.do', method : 'post'}).submit();
