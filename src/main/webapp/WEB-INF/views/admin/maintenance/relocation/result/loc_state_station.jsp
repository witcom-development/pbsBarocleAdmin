...
<body>
							...
							<form id="searchFrm">
								...
								<fieldset>
									...
									<div class="shBoxSection">
										...
										<div class="section">
											<label for="bikeNo" class="laType02">대여소 번호</label>
    ...
    relocationStateList.exeListFnc = function(e) {
        ...
        $("#searchFrm").attr({method : 'post', action : '/relocationStateStation.do'}).submit();
    };
    ...
    relocationStateList.pageSelect = function(pageNo) {
    	...
    	$("#searchFrm").attr({action :'/relocationStateStation.do', method : 'post'}).submit();
