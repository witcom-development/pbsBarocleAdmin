...
<%-- 										 		<input type="hidden" id="histYn" name="histYn" value="${info.remote_use_yn }"> --%>
						 ...
						 <%-- 
						  ...
						  --%>
						<div id="childDiv">
							<p class="head ttbtncase1">원격반납정거장 설치<span><button type="button" class="btnType05" id="btn_addCode">추가</button></span></p>
...
<!-- 												</p> -->
								...
								<div class="btnArea">
									<c:if test="${cmd == 'INFO'}">
										...
										<span class="right" onclick="vallidateModify('UPDATE','${info.station_grp_seq}'); return false;"><button class="btnType01 bc_green">저장</button></span>
										<span class="right" onclick="fn_delete('${info.station_grp_seq}'); return false;"><button class="btnType01 bc_green">삭제</button></span>
									</c:if>
