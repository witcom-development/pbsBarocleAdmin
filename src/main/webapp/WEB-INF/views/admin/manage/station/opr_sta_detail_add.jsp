					  ...
					  if((data.isDup === "true")) {
						  ...
						  if(data.resultVo != null && data.resultVo.nowLocateId !=null && data.resultVo.nowLocateId !=''){
							  ...
							  if(confirm(data.resultVo.stationName+data.resultVo.centerName+ '에 이미 등록된 비콘입니다 변경하시겠습니까?')) {
								...
								fn_matchingBeacon(data.resultVo.deviceId,oldDeviceId);	//바로 등록 ㄱㄱ
							  } else {
				...
				<div class="content">
					...
					<div class="page">
							<fieldset>
								...
								<div class="btnArea">
									<span class="right" onclick="fn_regist(); return false;"><button class="btnType01 bc_green">등록 저장</button></span>
								</div>
							</fieldset>
							</div>
							</div>
