...
<script type="text/javaScript">
	...
	function linkPage(pageNo){ location.href = "/admin/manage/center/centerList.do?currentPageNo="+pageNo+"<c:out value='${parameterInfo}' escapeXml='false'/>"; }
</script>
</head>
<body>
	<div class="allwrap">
			...
			<div class="cont">
				...
				<div class="content">
					...
					<div class="page">
						...
						<!--검색조건 S-->
						<div class="shBox">
							<form:form id="frm" commandName="form" action="/admin/manage/center/centerList.do" accept-charset="utf-8" modelAttribute="centerView">
								<fieldset>
									<legend>검색조건</legend>
									...
									<c:when test="${fn:length(centerList) > 0 }">
										<c:forEach items="${centerList}" var="centerList" varStatus="status">
											<tr>
												...
												<td class="title"><a href="/admin/manage/center/centerEdit.do?mode=edit&centerID=${centerList.centerID}<c:if test="${centerView.currentPageNo!=0}">&currentPageNo=<c:out value='${centerView.currentPageNo}'/></c:if><c:out value='${parameterInfo}'/>"><c:out value="${centerList.centerName}" /></a></td>
					...
					<c:choose>
						...
						<div class="btnArea">
							<span class="right"><button class="btnType01 bc_green" onclick="location.href='/admin/manage/center/centerEdit.do<c:if test="${centerView.currentPageNo ne '' && centerView.currentPageNo ne null}">?currentPageNo=<c:out value='${centerView.currentPageNo}'/></c:if><c:out value='${parameterInfo}' escapeXml='false'/>';">등록</button></span>
						</div>
					</div>
				</div>
				<!--content E-->
