		...
		<div class="menuClose" style="color: #fff; padding-top: 10px;">
	     ...
	     <div id="slideNav" style="background: #11503d;height: 100%;">
	         ...
	         <table style="padding : 10%; position: relative; top: 50px;">
	             ...
	             <tr>
	                 <td><button class="navBtn" type="button" style="color: #fff;">차량등록</button></td>
	             </tr>
	             <tr>
	                 <td><button class="navBtn" type="button" style="color: #fff;">자전거 검색</button></td>
	             </tr>
	             <tr>
	                 <td><button class="navBtn" type="button" style="color: #fff;">자전거 대량이동</button></td>
	             </tr>
	             <tr>
	                 <td><button class="navBtn" type="button" style="color: #fff;">지도</button></td>
	             </tr>
	             <tr>
	                 <td><button class="navBtn" type="button" style="color: #fff;">분배일지</button></td>
	             </tr>
	             <tr>
