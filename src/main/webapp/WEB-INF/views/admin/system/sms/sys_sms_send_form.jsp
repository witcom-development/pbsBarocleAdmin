						...
						<form id="frm">
							...
							<fieldset>
								<table class="tb_type02 mt20">
									...
									<tbody>
										<tr>
											<th class="top">수신 번호</th>
											<td class="top">
											<!-- <span class="pholder input-text07"> -->
												<label for="phonNo"></label><input id="phonNo" name="phonNo" type="text" maxlength="13" style="width: 99%;" ><!-- IME-MODE: disabled -->
											<!-- </span> -->
											</td>
										</tr>
										<tr>
											<th>발송자</th>
											<td id="phoneTxt">
											<span style="width: 220px;" readonly="readonly">
												<input type="hidden" value="<%= com.dkitec.barocle.admin.login.security.filter.EgovSessionCookieUtil.getSessionAttribute(request, "usrId") %>" id="loginId"> 
										...
										<tr>
											...
											<td>
												<span class="input-ck01">
													<input type="checkbox" class="vm" id="sendType1" disabled="disabled" name="sendType" value="001" checked/>&nbsp;문자&nbsp;&nbsp;	<!-- 카카오톡/ -->
										...
										<tr>
											<th>발송 제목</th>
											<td><input type="text" id="subTitle" name="subTitle" style="width: 99%;"></td>
										</tr>
										<tr>
											<th>발송 내용</th>
