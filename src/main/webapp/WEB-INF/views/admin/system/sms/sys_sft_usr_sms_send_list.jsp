	...
	<div class="allwrap">
		...
		<script type="text/javascript">
			...
			function checkSubmit(){ 
				...
				$("#frm").attr('action','/admin/service/safetycert/sendSafetyUserSmsList.do').submit();
				return true;
			}
			
			function linkPage(pageNo){
				$("[name='currentPageNo']").val(pageNo);
		        $("#frm").attr({method : "post", action : "<c:out value='/admin/service/safetycert/sendSafetyUserSmsList.do'/>"}).submit();
			}
