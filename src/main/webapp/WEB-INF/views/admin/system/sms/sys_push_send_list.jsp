	...
	<div class="allwrap">
						...
						<table class="tb_type01" id="smsinfo">
							...
							<tbody>
								<c:choose>
									...
									<c:otherwise>
										<tr>
											<td colspan="5" style="text-align: center;"><spring:message code="search.nodata.msg" /></td>
										</tr>
									</c:otherwise>
								</c:choose>
							</tbody>
		...
		<script type="text/javascript">
			...
			function checkSubmit(){ 
				...
				$("#frm").attr('action','/admin/service/policyMgmt/pushSendList.do').submit();
				return true;
			}
			
			function linkPage(pageNo){
				$("[name='currentPageNo']").val(pageNo);
		        $("#frm").attr({method : "post", action : "<c:out value='/admin/service/policyMgmt/pushSendList.do'/>"}).submit();
			}
