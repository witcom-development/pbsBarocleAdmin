								...
								<c:choose>
									<c:when test="${fn:length(dalList) > 0 }">
										<c:forEach items="${dalList}" var="dalList" varStatus="status">
											<tr>
												<td class="title"><c:out value="${dalList.dclzStrDt}"/></a></td>
												<td class="tc"><c:out value="${dalList.dclzCd}" /></td>
												<td class="tc"><c:out value="${dalList.prvonsh}" />(<c:out value="${dalList.prvonsh}" />)</td>
									...
									<c:otherwise>
										<tr>
											<td colspan="6"><spring:message code="search.nodata.msg" /></td>
										</tr>
									</c:otherwise>
								</c:choose>
							</tbody>
