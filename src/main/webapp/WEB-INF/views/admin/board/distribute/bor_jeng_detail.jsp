					...
					<div class="page">
						<form id="tx_editor_form" name="tx_editor_form" method="post" accept-charset="utf-8" onsubmit="return false;">
							...
							<fieldset>
								...
								<table class="tb_type02 mt20">
									...
									<tbody>
										...
										<tr>
											<th>공지대상</th>
											<td>
												<span class="input-ck01"><input type="checkbox" id="a4" name="siteClsCD" value="jeng" checked="checked" /><label for="a4">정비원</label></span>
								...
								<div class="btnArea">
									<span class="left"><button class="btnType01 bc_gray" onclick="location.href='/admin/board/distribute/getJengBoardList.do?currentPageNo=<c:out value="${distributeBoardView.currentPageNo}"/><c:out value="${parameterInfo}" escapeXml="false"/>';">목록</button></span>
									<span class="right">
