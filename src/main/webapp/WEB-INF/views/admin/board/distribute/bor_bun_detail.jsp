				...
				<div class="content">
					...
					<div class="page">
						<form id="tx_editor_form" name="tx_editor_form" method="post" accept-charset="utf-8" onsubmit="return false;">
							...
							<input type="hidden" id="cateCD" name="cateCD" value="B"/>
							<fieldset>
								...
								<table class="tb_type02 mt20">
									...
									<tbody>
										...
										<tr>
											<th>공지대상</th>
											<td>
												<span class="input-ck01"><input type="checkbox" id="a3" name="siteClsCD" value="bun" checked="checked"/><label for="a3">분배원</label></span>
												<span class="input-ck01"><input type="checkbox" id="a2" name="siteClsCD" value="sang" <c:if test="${fn:indexOf(distributeBoardView.siteClsCD,'sang')>-1}">checked="true"</c:if>/><label for="a2">상담원</label></span>
								...
								<div class="btnArea">
									<span class="left"><button class="btnType01 bc_gray" onclick="location.href='/admin/board/distribute/getBunBoardList.do?currentPageNo=<c:out value="${distributeBoardView.currentPageNo}"/><c:out value="${parameterInfo}" escapeXml="false"/>';">목록</button></span>
									<span class="right">
