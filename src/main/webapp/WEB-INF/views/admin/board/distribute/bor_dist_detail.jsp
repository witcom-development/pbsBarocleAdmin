				...
				<div class="content">
					...
					<div class="page">
						<form id="tx_editor_form" name="tx_editor_form" method="post" accept-charset="utf-8" onsubmit="return false;">
							...
							<input type="hidden" id="cateCD" name="cateCD" value="0"/>
							<fieldset>
								...
								<div class="btnArea">
									<span class="left"><button class="btnType01 bc_gray" onclick="location.href='/admin/board/distribute/distBoardList.do?currentPageNo=<c:out value="${distributeBoardView.currentPageNo}"/><c:out value="${parameterInfo}" escapeXml="false"/>';">목록</button></span>
									<span class="right">
