...
<body>
    ...
    $(function() {
        ...
        $("#uploadBtn").on("click", {devType :'sft'}, function(e){
            e.preventDefault();
            e.stopPropagation();
            ...
            $("[name='frm']").attr('action', "/admin/service/safetycert/insertSafetyCertUserWithExcel.do").submit();
        });
    });    
    function closePop() {
    ...
    function setExcelLink() {
    	var $exeLink = $("<a>");
	         $exeLink.attr({href : '/excelSample/SAFETY_CERT_USER_sample.xlsx'}).text("인증제 합격자 Excel 샘플 down.").css("color", "#0033CC"); 
    		$(".btnArea").append($exeLink);
    }
    
    function setExcelLinkOld(type) {
    	if (type !== '') {
	    	 var $exeLink = $("<a>");
	    	 var devName = "";
	         if(type ==="DEV_001") {
