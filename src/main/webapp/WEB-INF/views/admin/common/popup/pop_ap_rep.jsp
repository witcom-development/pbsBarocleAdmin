...
<body>
    ...
    <div class="cntbox">
        <div class="allwrap pop">
        	<form id="frm">
        		...
        		<input type="hidden" name="equipmentId" value="${resultVo.equipmentId == null ? troubleReportVo.equipmentId : resultVo.equipmentId}">
	            ...
	            <table class="tb_type02 mt20">
	                ...
	                <tbody>
	                    <tr>
	                        <th class="top"><em>*</em> 무선 AP ID</th>
	                    ...
	                    <tr>
	                        <th><em>*</em> 비고</th>
	                        <td><textarea id="faultContent" class="detatextarea">${resultVo.faultContent}</textarea></td>
	                    </tr>
	                </tbody>
	            </table>
            </form>
    ...
    $(function() {
    	commonAjax.getCommonCode("ELA", function(data){
	    	...
	    	commonAjax.postAjax("/common/pop/exeTroubleAjax.do", 'json', $("#frm").serialize()
       			, function(data){
       	        	if(data.resultMessage == 'Insert'){
                        ...
                        if(isChk) {
                           alert('<spring:message code="fail.fault.exist.chk" arguments="AP"/>');  
                           return false;
                        }
