...
<body>
	<h1 class="popTtl"><c:out value="${popupView.distTitle}" /></h1>
	<div class="cntbox"><c:out value="${popupView.distHTMLContent}" escapeXml="false" /></div>
	...
	<script>
	function closePop(){
		opener.setCookie('<c:out value='${distributeBoardVO.distSeq}'/>');
		window.close();
	}
	</script>
</body>
