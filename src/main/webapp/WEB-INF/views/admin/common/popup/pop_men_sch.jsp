...
<body>
            ...
            <div class="shBox_pop">
                <div class="shBoxSection">
					<span class="section pwtableblock">
						<label for="usrGrpCd" class="laType02">운영자 구분</label>
						<select class="" id="usrGrpCd" >
							<option value="001">운영 관리자</option>
							<option value="002">유인대여소 관리자</option>
							<option value="003">센터 관리자</option>
							<option value="004">유지보수 관리자</option>
							<option value="005">재배치 관리자</option>
						</select>
    ...
    $(function() {
    	...
    	commonAjax.getAdminList(usrGrpCd, usrName,
       		function(data) {
