...
function createTree(arrName, vYeobu) {
   var startNode =null, openNode = null;
   treeNodes = arrName,treeYeobu = vYeobu;
	if (treeNodes.length > 0) {
		preloadIcons(this.getImagePath());
		...
		else document.write("<a href='" + "javascript:rootClick()"+"'><img src='"+imgpath+"menu_base.gif' border='0' align='absbottom' alt='' >root<br></a><br>");
