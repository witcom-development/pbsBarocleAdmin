 ...
 * */
//2018-11-28 index 5번 100 이상 데이터 이미지  추가 staStop_ss100p  2019-01-18 장애 에러 수정
nMap.markerImages = ["/images/staOn_s0p.png","/images/staOn_s25p.png","/images/staOn_s50p.png","/images/staOn_s75p.png","/images/staOn_s100p.png",'/images/staStop_ss150p.png'];

nMap.markerErrImages = ["/images/staErr_s0p.png","/images/staErr_s25p.png","/images/staErr_s50p.png","/images/staErr_s75p.png","/images/staErr_s100p.png",'/images/staErr_s100p.png'];

nMap.markerSmallImages = ["/images/staOn_ss0p.png","/images/staOn_ss25p.png","/images/staOn_ss50p.png","/images/staOn_ss75p.png","/images/staOn_ss100p.png","/images/staStop_ss150p.png"];

nMap.markerSmallErrImages = ["/images/staErr_ss0p.png","/images/staErr_ss25p.png","/images/staErr_ss50p.png","/images/staErr_ss75p.png","/images/staErr_ss100p.png","/images/staErr_s100p.png"];

nMap.makerStopImages      = ['/images/staStop_s0p.png','/images/staStop_s25p.png','/images/staStop_s50p.png','/images/staStop_s75p.png','/images/staStop_s100p.png','/images/staStop_ss150p.png'];

nMap.makerSmallStopImages = ['/images/staStop_ss0p.png','/images/staStop_ss25p.png','/images/staStop_ss50p.png','/images/staStop_ss75p.png','/images/staStop_ss100p.png','/images/staStop_ss150p.png'];
...
nMap.setMap = function() {
	...
	nMap.map = new naver.maps.Map("mapDiv", {
        size: new naver.maps.Size(mSize.w, mSize.h),
...
nMap.makeStationMapInfo = function() {
	...
	//arg[0] ->  거치율.  arg[1] -> 장애유무
    	...
    	if (  parseInt ( _this.targetViewData[i].latitude ) <= 0 )  { 
    		console.log(  _this.targetViewData[i].latitude );
    		continue;
    	}
...
function getClickHandler(seq) {
	...
	//console.log(infoData.rackInfo);
	//console.log(infoData.bikeInfo);
	//console.log(infoData.shared);
	...
	cont += '       <p style="display:inline-block; margin:5px; vertical-align:top;"><img src="/images/mapNoimg.gif" style="width:50px; height:50px" alt="" /></p>';
	...
	infoWindow.open(nMap.map,center);
	 ...
	 nMap.map.panTo(e.coord); //2020-11-04 : 마커를 화면 중심으로 
...
nMap.getSharedImgSrc = function(pShared, pDeviceBFlg, pStopFlg) 
{
	...
	else if( s <= 130 ) {iidx=4;}	// 2018-11-28 index 조건 변경
	else if( 130 < s ) {iidx=5;}	// 2018-11-28 index 조건 추가
	if( s === 0) {iidx=0;} 
	
 	{
		if(pDeviceBFlg){
			// 2018-11-28 small이미지로 변경
